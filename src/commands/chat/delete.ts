...
//   description: 'Delete some unwanted messages from the channel.',
//   descriptionLocalizations: { 'pt-BR': 'Apague algumas mensagens indesejadas do canal.' },
//   options: [
//     {
//       required: true,
...
//       minValue: 1,
// 			maxValue: 100,
//       nameLocalizations: { 'pt-BR': 'quantia' },
//       description: 'A amount of messages to delete.',
//       descriptionLocalizations: { 'pt-BR': 'A quantia de mensagens à deletar.' }
//     }, {
// 			required: false,
// 			type: Discord.ApplicationCommandOptionType.Boolean,
// 			name: 'force',
// 			nameLocalizations: { 'pt-BR': 'forçar' },
// 			description: 'Forces deletation of messages that was sent before 14 days ago.',
// 			descriptionLocalizations: { 'pt-BR': 'Deleta forçadamente mensagens enviadas à mais de 14 dias.' }
// 		}
//   ]
// }, async (interaction) => {
// 	if (!interaction.channel.permissionsFor(interaction.guild.members.me, true).has('ManageMessages', true)) return interaction.sendReply({
